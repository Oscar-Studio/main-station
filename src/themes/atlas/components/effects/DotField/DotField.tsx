...
const DotField = memo(({
  ...
  propsRef.current = { dotRadius, dotSpacing, cursorRadius, cursorForce, bulgeOnly, bulgeStrength, sparkle, waveAmplitude, gradientFrom, gradientTo, disableGlow };
  ...
  useEffect(() => {
    ...
    function tick() {
      ...
      if (glowEl && !(p.disableGlow as boolean)) {
