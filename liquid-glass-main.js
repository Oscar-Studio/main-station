...
(function () {
    ...
    const QUALITY_PRESETS = {
        high: { edge: 60, refr: 60, curve: 2.0, frost: 0.6, ca: 12, alpha: 0.15 },
        mid:  { edge: 50, refr: 50, curve: 2.0, frost: 0.0, ca: 0,  alpha: 0.12 },
    ...
    class LiquidGlassInstance {
            ...
            const fsSrc = `
                ...
                void main() {
                    ...
                    if (u_hasUserBg > 0.5) {
                        ...
                        float t = v_uv.y;
                        bgColor = vec4(mix(vec3(0.06, 0.09, 0.16), vec3(0.10, 0.05, 0.15), t), 1.0);
                    }
        ...
        _collectRects() {
            ...
            const nodes = root.querySelectorAll('.glass-element');
